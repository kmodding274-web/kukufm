...
// Updated Premium Headers (Naye Datadog trace IDs aur headers ke saath)
const HARDCODED_PREMIUM_DATA = {
    ...
    "x-datadog-trace-id": "3642838718614118258",
    "x-datadog-parent-id": "5530090608538513717",
    "x-datadog-origin": "rum",
    "x-datadog-tags": "_dd.p.tid=6aa6e53400000000,_dd.p.rsid=b2013230-6824-4b73-b598-d880497c9c8d",
    "x-datadog-sampling-priority": "0",
    "traceparent": "00-6aa6e53400000000328df68395089f72-5530090608538513717-00",
    "tracestate": "dd=p:5530090608538513717;s:0;o:rum",
    ...
    "if-modified-since": "Sun, 13 Sep 2026 18:02:20 GMT",
...
app.all('*', async (req, res) => {
    ...
    try {
        ...
        // 1. URL Decode incoming body format for proxying
        if (typeof payloadData === 'object' && payloadData !== null) {
            payloadData = querystring.stringify(payloadData);
        }

        // 2. Refresh token body rewrite
        ...
        // 4. Intercept token reply and replace with token.json for App
