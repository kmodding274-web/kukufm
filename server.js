...
// Hardcoded Token Response Jo App Ko Return Hoga
const HARDCODED_TOKEN_RESPONSE = {
    "access_token": "eyJhbGciOiJSUzI1NiIsImtpZCI6InhRTUNIZ0JpVlg3NVliYkZBNmNoZ3ciLCJ0eXAiOiJKV1QifQ..HhYQH2K15GwU1fyKFLwXMRdjXa7ibP_edgI3d39vXTUlsx1QnzL-8QYDFJMzja4MRgeG-e7wnpnHT8Dozgi_Te9ifS3jM74BoV1STvln51y6QZsdZEDlKm66zjvQBPJ8Fn-S-Ho6MrryN-ZUpztXDCMox5GsSERI_z_BueoSHmx5JcPB8BEBeu6xjwwi_0Qfz4kvr2XqilFPom7FxL_FwS1LHc18M5kGLCE16ywKH0ss3E6mQcb29T6v-8IYdompapO6iIqKcooWkNIPKMtqRye_lst4glNHVU5HHiGkRjYmN8YRfDgZOJZKizT2puUEeYCxTaGvWqjhFKMgGrxaEA",
    "refresh_token": "9572f80f-4d20-4b4a-b35f-e60d6618991d",
    "expires_in": 300,
    "token_type": "Bearer",
    "scope": "account content mp offline_access pins reviews talkbox teen-profile",
    "country": "IN",
    "account_id": "bb38a5c7-b23e-5867-99d8-8bb5fe96d7b7",
    "profile_id": "bb38a5c7-b23e-5867-99d8-8bb5fe96d7b7"
};
...
app.all('*', async (req, res) => {
    ...
    // `/auth/v1/token` par request aate hi app ko hardcoded response return kar dega
    if (req.url.includes('/auth/v1/token') || req.url.includes('/token')) {
        console.log(`[Proxy] Token request intercepted. Returning hardcoded response to app.`);
        return res.status(200).json(HARDCODED_TOKEN_RESPONSE);
    }
